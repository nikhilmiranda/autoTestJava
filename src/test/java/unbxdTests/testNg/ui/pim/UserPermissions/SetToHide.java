...
public class SetToHide extends BaseTest {
    ...
    @Page
    PropertyListing_page propertiesPage;
    ...
    public void changeAllTheSystemPermissionsToHide() throws InterruptedException {
        ...
        manageRolePage.setSystemPermission1(systemPermissions, SystemPermissions.HIDE.getDesc());
    ...
    public void verifyOrganisationSetupIsHidden() throws InterruptedException {
        ...
        homePage.clickOnUserMenuIcon();
        Assert.assertEquals(homePage.isViewOrganizationPresent().booleanValue(),false);
        homePage.clickOnUserMenuIcon();
    }

    @Test(priority = 3)
    public void verifyIfPropertiesIsHidden() {
        Assert.assertEquals(homePage.isSubMenuDisplayed("Properties").booleanValue(),false);
    }

    @Test(priority = 4)
    public void verifyIfTasksIsHidden() {
        Assert.assertEquals(homePage.isSubMenuDisplayed("Tasks").booleanValue(),false);
    }

    @Test(priority = 5)
    public void verifyIfProductsIsHidden() {
        Assert.assertEquals(homePage.isMenuDisplayed("Products").booleanValue(),false);
    }
...
//    @Test(priority = 9)
//    public void changeThePropertyPermissionToHide() throws InterruptedException {
//        homePage.clickOnUserMenuIcon();
//        homePage.clickOnViewOrganization();
//        myOrganisationPage.clickOnRolesTab();
//        rolesListingPage.clickOnRoleEditIcon(role2);
//        manageRolePage.clickOnSystemPermissionsTab();
//        manageRolePage.waitForManageRoleToAppear();
//        manageRolePage.setPropertyPermission1("Fabric", "hide");
//        manageRolePage.clickOnUpdate();
...
//
//    @Test(priority = 11)
//    public void verifyIfThePropetyIsHiddenInPropertySection() {
