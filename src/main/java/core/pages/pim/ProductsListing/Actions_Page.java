package core.pages.pim.ProductsListing;
...
public class Actions_Page extends FluentPage {
    ...
    @FindBy(how = How.NAME, using = ".static-dd-modal li:nth-child(4)")
    FluentWebElement assignTaskForProductLink;

    @FindBy(how = How.CSS, using = ".static-dd-modal li:nth-child(5)")
    FluentWebElement certifyForNetworkLink;

    @FindBy(how = How.NAME, using = ".static-dd-modal li:nth-child(6)")
